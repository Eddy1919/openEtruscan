...
class NameFormula:
    ...
    def praenomen(self) -> str | None:
        """Return the first identified praenomen from the formula."""
    ...
    def gentilicium(self) -> str | None:
        """Return the primary gentilicium (clan name) from the formula."""
        for c in self.components:
    ...
    def patronymic(self) -> str | None:
        """Return the patronymic (father's name) component, if present."""
        for c in self.components:
    ...
    def to_dict(self) -> dict:
        """Serialize the name formula to a dictionary for API and graph exports."""
        return {
            "raw": self.raw,
...
class Person:
    ...
    @property
    def praenomen(self) -> str | None:
        """Property proxy for the individual's praenomen."""
        return self.name_formula.praenomen()

    @property
    def gentilicium(self) -> str | None:
        """Property proxy for the individual's primary clan name."""
        return self.name_formula.gentilicium()

    @property
    def gender(self) -> str:
        """Property proxy for the inferred gender of the individual."""
...
class ClanInfo:
    ...
    def member_count(self) -> int:
        """Return the number of individuals associated with this clan."""
        return len(self.members)

    def to_dict(self) -> dict:
        """Serialize the clan profile including full member enrollment."""
        return {
            "name": self.name,
...
class FamilyGraph:
    ...
    def _to_json(self) -> str:
        """Export the full graph to a JSON string representation."""
        data = {
            "persons": [
                {
                    "id": p.id,
