...
from openetruscan.core.converter import convert
from openetruscan.core.normalizer import normalize
from openetruscan.core.validator import validate_file
...
def export_corpus(
    ...
    if fmt == "epidoc":
        from openetruscan.core.epidoc import corpus_to_epidoc
...
def classify(
    ...
    from openetruscan.core.corpus import CLASSIFICATIONS
