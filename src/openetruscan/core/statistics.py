...
class FrequencyResult:
    ...
    def to_dict(self) -> dict:
        """Serialize letter frequency results including raw counts and normalized shares."""
        letters = [
            {
                "letter": lt,
...
class ComparisonResult:
    ...
    def to_dict(self) -> dict:
        """Serialize statistical comparison metrics including Chi-squared values and p-values."""
        return {
...
class ClusterResult:
    ...
    def to_dict(self) -> dict:
        """Serialize clustering results including PCA coordinates and site vectors."""
...
def cluster_sites_from_texts(
    ...
    for row in rows:
        spot = (row.get("findspot") or "").strip()
        canonical = row.get("canonical")
        if spot and canonical:
            site_texts.setdefault(spot, []).append(canonical)
...
class DatingResult:
    ...
    def to_dict(self) -> dict:
        """Serialize the orthographic dating result including detected features and tag scores."""
        return {
            "period": self.period,
...
class BayesianDatingResult:
    ...
    def to_dict(self) -> dict:
        """Serialize the Bayesian posterior distribution over chronological time bins."""
        return {
