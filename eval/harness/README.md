...
> **Note.** The old `api.openetruscan.com` host is **retired**. The live search
> API is now `https://www.openetruscan.com/api` (co-located Vercel route
> handlers, Neon-backed) — used in the commands below.
...
python eval/harness/run_search_eval.py --api-url https://www.openetruscan.com/api

# get a structured report
python eval/harness/run_search_eval.py --api-url https://www.openetruscan.com/api --json
