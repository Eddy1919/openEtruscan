...
Reads the labelled query set from ``eval/harness/search_eval_queries.jsonl`` and
...
findspot strings) plus a lexical baseline. See ``eval/harness/README.md`` for the
methodology.

Usage:
    python eval/harness/run_search_eval.py [--api-url https://api.openetruscan.com]
    python eval/harness/run_search_eval.py --json   # machine-readable output
    python eval/harness/run_search_eval.py --gate macro_mean=0.40,place_pleiades=0.30
