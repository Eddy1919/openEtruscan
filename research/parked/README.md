...
| `NEUROSYMBOLIC_WBS.md` | Work-breakdown for the VSA/neurosymbolic strand (WP1 was built — see `research/experiments/vsa_role_filler/`). | Same as above; the experiment stays where it is, only the forward plan is parked. |
