...
The Etruscan directory contains the frozen annotation protocols; osc/fal/rae are scaffolds (README only — protocols TODO). Codebooks are versioned independently per language and are referenced by ISO-639-3 code:
