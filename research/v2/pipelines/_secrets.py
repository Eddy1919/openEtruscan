...
2. Otherwise fetch from Secret Manager in the GCP project named by
   `SECRET_MANAGER_PROJECT_ID` (default `your-gcp-project-id`), version
   `latest`.
...
DEFAULT_PROJECT_ID = os.environ.get("SECRET_MANAGER_PROJECT_ID", "your-gcp-project-id")
