...
| `export_rejected.py` | Export `provenance_status='rejected'` rows | `DATABASE_URL` | `data/rejected_inscriptions.csv` |
| `export_openapi.py` | Dump the FastAPI OpenAPI schema | `openetruscan.api.server` app | `docs/openapi.json` |
