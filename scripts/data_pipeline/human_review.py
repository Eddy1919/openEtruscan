...
def human_review():
    ...
    print("\n" + "=" * 50)
    print(" HUMAN-IN-THE-LOOP (HITL) REVIEW QUEUE ")
    ...
    for idx, item in enumerate(data):
        ...
        while True:
            choice = input("👉 Accept? [y/n/e/q]: ").strip().lower()
        ...
        if choice == "q":
            ...
            with tempfile.NamedTemporaryFile(suffix=".json", mode="w+") as tf:
                ...
                try:
                    ...
                    print(
                        f"   ⚠️ Invalid JSON structure returned from system editor! Item bypassed to prevent data poison. {e}"
                    )
