...
def generate_report():
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            f"Parsed **{len(parsed_ranges)}** compound entries into individual unique inscriptions.\n"
        )
        f.write(
            "The child records will inherit the entire commentary and parent record context.\n\n"
        )
