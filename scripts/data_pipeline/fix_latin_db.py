...
c.execute(
    "UPDATE cie_review SET language_hint='likely_latin_morphology' WHERE original_script='likely_latin_morphology'"
)
c.execute(
    "UPDATE cie_review SET original_script='' WHERE original_script='likely_latin_morphology'"
)
conn_lat.commit()
conn_lat.close()
