...
using Gemini 2.5 Pro on Vertex AI (billed to `your-gcp-project-id`).
...
substituted: same gcloud-native auth path, same billing to a
now-retired GCP project, comparable structured-extraction quality on short
