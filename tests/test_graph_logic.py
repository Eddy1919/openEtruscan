...
async def test_get_concordance_network(db_session: AsyncSession):
    ...
    ins1 = InscriptionData(
        id="INS_1",
        trismegistos_id="TM_1",
        raw_text="...",
        canonical="...",
        findspot="...",
        medium="stone",
...
async def test_get_names_network(db_session: AsyncSession):
    ...
    # 4. Add Relationship
    rel = Relationship(person_id="P1", related_person_id="P2", relationship_type="brother")
    rel2 = Relationship(person_id="P1", clan_id="C1", relationship_type="member_of")
